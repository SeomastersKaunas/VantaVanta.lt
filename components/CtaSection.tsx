...
const CtaSection = () => {
  ...
  return (
    <>
      <section className="relative max-w-[1440px] mx-auto px-8">
        <div className=" relative  py-[20px] md:py-[58px] px-[20px] md:px-[76px] w-full">
            ...
            <div className="">
              ...
              <div className="mt-10">
                <button
                  ...
                  className="group flex cursor-pointer items-center justify-between gap-x-6 bg-[#0F543F] px-[25px] md:px-[30px] py-[18px] md:py-[22px] text-[26px] font-medium -tracking-[1.2px] text-white transition-colors hover:bg-[#0d5741] max-w-[471px] w-full "
                >
